...
const page = () => {
  ...
  return (
    <div className="hero min-h-screen" style={{ backgroundImage: backgroundImageUrl }}>
         ...
         <div className='justify-center items-center w-1/2 mt-[-100px] '>
         <h2 className='text-3xl text-base-100 font-bold mb-5 text-center uppercase'>🐶🐱🐰 Curenimal 🐰🐱🐶 </h2>
        <p className='text-lg font-bold text-center'>Welcome to our compassionate community dedicated to the well-being of our furry friends! 🐾 <br />
        ...
        <br />
        <p className='text-xl font-bold '>How do we help:</p>
        <ol>
            <li>
        ...
        <p className='text-lg font-bold'>Thank you for being a part of Curenimal. Together, let's make a difference in the lives of our beloved pets and the animals who need us most.</p>
         </div>
